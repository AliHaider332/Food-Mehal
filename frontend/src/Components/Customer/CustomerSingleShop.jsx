...
const CustomerSingleShop = () => {
  ...
  const { addToCart, removeFromCart, getItemQuantity, isInCart, cart } =
    useCart();
  ...
  useEffect(() => {
    ...
    setCartItemsCount(getCartTotalItems());
  }, [cart]);

  const fetchShopDetails = async () => {
    setLoading(true);
    try {
      const response = await axiosInstance.get(`user/shop/${id}`);
  ...
  const handleUpdateQuantity = (item, quantity, e) => {
    e.stopPropagation();
    if (quantity <= 0) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      {cartItemsCount > 0 && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-3 rounded-full shadow-2xl hover:shadow-xl transition-all duration-300 flex items-center gap-3 group animate-bounce-slow"
        >
          <div className="relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            {cartItemsCount > 0 && (
              <div className="bg-orange-50 px-4 py-2 rounded-full shadow-sm flex items-center gap-2">
                ...
                >
                  ...
                  <div className="relative h-52 overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200">
                    ...
                    {inCart && cartQuantity > 0 && (
                      <div className="absolute bottom-3 right-3 bg-orange-500 text-white px-2 py-0.5 rounded-full text-xs font-bold shadow-lg">
                        {cartQuantity}
                      </div>
                    )}
                  </div>
                        ...
                        <div className="flex items-center gap-2">
                          {inCart && cartQuantity > 0 ? (
                            ...
                            <button
                              ...
                              className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-4 py-2.5 rounded-xl transition-all duration-200 hover:scale-105 flex items-center gap-2 text-sm font-semibold shadow-md"
                            >
        ...
        <div className="mt-12 bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-5 border border-orange-100">
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-sm text-gray-700">
            ...
            {cartItemsCount > 0 && (
              <div className="flex items-center gap-2 ml-4 pl-4 border-l border-orange-200">
                <div className="bg-orange-100 p-1.5 rounded-full">
                  <FaShoppingCart className="text-orange-500 text-sm" />
                </div>
                <span>
...
export default CustomerSingleShop;
